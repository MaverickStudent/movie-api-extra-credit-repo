        ...
        <div class="d-flex flex-column">
          ...
          >
            <svg
                ...
                width="50" height="50" fill="#0275d8"
          ...
          <button @click="sortList('name')"> Sort Name </button>
        </div>
        <!--        movie list-->
        <div class="card" v-for="movie in movies" v-bind:key="movie">
          ...
          >
            <div class="card-body">
              ...
              <p><b>Movie Rating:</b> {{ movie.watchrating }}</p>
              <p><b>Year:</b> {{ movie.year }}</p>
              <p>{{ movie.description }}</p>
              <p><a :href="movie.website" target="_blank">Details</a></p>
              <div class="btn-group">
      ...
      <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
        <table class="table table-hover" style="overflow-y: auto" :headers="headers">
          ...
          <tr>
            ...
            <th @click="sortList('description')" scope="col">Description</th>
            <th @click="sortList('year')" scope="col">Year</th>
            <th @click="sortList('rating')" scope="col">Rating</th>
            <th @click="sortList('watchrating')" scope="col">Watch Rating</th>
          ...
          <tr v-for="(movie, index) in movies" v-bind:key="index">
            ...
            <td>{{ movie.year }}</td>
            <td>{{ movie.rating }}</td>
            <td>{{ movie.watchrating }}</td>
            <td><a :href="movie.website" target="_blank">Details</a></td>
...
export default {
  ...
  methods: {
    sortList(sortBy) {
      if (this.sortedbyASC) {
        this.movies.sort((x, y) => (x[sortBy] > y[sortBy] ? -1 : 1));
